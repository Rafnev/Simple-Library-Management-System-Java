...
public class StudentListView extends javax.swing.JFrame {
     ...
     */
    public StudentListView(String[][] rows) {
        initComponents();
...
StudentWindow obbw = new StudentWindow();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentListView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       ...
       final String[][] rows = null;
        java.awt.EventQueue.invokeLater(new Runnable() {

            public void run() {
                new StudentListView(rows).setVisible(true);
            }
        });
    }
